defmodule ShoppingListWeb.ItemControllerTest do
  ...
  import ShoppingList.ItemsFixtures

  @create_attrs %{bought: true, name: "some name"}
  @update_attrs %{bought: false, name: "some updated name"}
  @invalid_attrs %{bought: nil, name: nil}
